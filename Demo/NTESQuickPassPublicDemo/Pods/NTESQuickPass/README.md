...
| 3.2.0 | 2021.6.24 | 1.修复已知问题。
| 3.2.3 | 2021.7.15 | 1.授权页面支持 push。
| 3.2.4 | 2021.11.12 | 1.隐私协议支持抖动功能。
| 3.2.5 | 2021.11.26 | 1.授权页面弹出的过程中支持设置动画显示与取消。<br> 2.支持预取号缓存清除。
| 3.2.7 | 2022.05.07 | 1.协议数量支持到4个。
| 3.2.9 | 2022.06.01 | 1.隐私弹窗支持弹窗确认后直接登录。
| 3.3.1 | 2022.08.25 | 1.授权页面方向支持多种模式。
