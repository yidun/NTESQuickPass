...
@property (nonatomic,assign) BOOL customizedTransition;
...
/**登录按钮的宽度，默认200 ，与logBtnOffsetX结合使用*/
...
/**隐私条款的宽度，默认200 ，与 logBtnOffsetX 结合使用*/
@property (nonatomic, assign) CGFloat appPrivacyOriginWidth;
