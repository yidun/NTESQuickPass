...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of NTESQuickLogin.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yidun/NTESQuickLogin'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'luolihao123456' => 'luolihao123456@163.com' }
  s.source           = { :git => 'https://github.com/yidun/NTESQuickLogin.git', :tag => s.version.to_s }
